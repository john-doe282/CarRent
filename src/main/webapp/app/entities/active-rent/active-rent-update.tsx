        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : activeRentEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="active-rent-id">ID</Label>
                  <AvInput id="active-rent-id" type="text" className="form-control" name="id" required readOnly />
                </AvGroup>
              ) : null}
              <AvGroup>
              ...
              <AvGroup>
                ...
                <AvInput
                  ...
                  name="car.id"
                  value={isNew ? cars[0] && cars[0].id : activeRentEntity.car?.id}
                  required
                >
                  {cars
              ...
              <Button tag={Link} id="cancel-save" to="/active-rent" replace color="info">
